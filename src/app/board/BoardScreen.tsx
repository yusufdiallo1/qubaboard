...
export default function BoardScreen() {
  ...
  return (
    <>
      ...
      {/* Controls row: filter dropdown + search + view toggle */}
        ...
        <div className="fdrop" ref={dropRef}>
          ...
          >
            ...
            {filter !== 'all' && filter !== 'arrivals' && (
              <span className="dot" style={{ '--c': SCOLOR[filter] } as React.CSSProperties} />
            )}
              ...
              {FILTER_ORDER.map(({ k, icon }) => (
                ...
                >
                  {icon ? (
                    ...
                    <span className="dot" style={{ '--c': SCOLOR[k] } as React.CSSProperties} />
                  )}
